...
class Queue<T> {
  ...
  public Queue(int size) {
    ...
    /**
     * Only way to add object into the array is using the method enq().
     * Method enq() only accepts object of type T.
     * Hence, it is safe to cast 'Object[]' to 'T[]'.
     */
