    ...
    if (nextInShopQueue != null) {
      if (nextInCounterQueue != null) {
        return new Event[] {
          ...
          new ServiceBeginEvent(nextInCounterQueue, this.counter, this.getTime(),
              this.shop),
          new JoinCounterQueueEvent(nextInShopQueue, this.getTime(), this.counter)
        };
      } else {
        return new Event[] {
          new DepartureEvent(this.customer, this.getTime()),
          new ServiceBeginEvent(nextInShopQueue, this.counter, this.getTime(), this.shop),
        };
      }
    } else {
      if (nextInCounterQueue != null) {
        return new Event[] {
          new DepartureEvent(this.customer, this.getTime()),
          new ServiceBeginEvent(nextInCounterQueue, this.counter, this.getTime(), this.shop),
        };
      } else {
        return new Event[] {
          new DepartureEvent(this.customer, this.getTime())
