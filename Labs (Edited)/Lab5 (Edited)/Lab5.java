...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> dbWrap = new Constant<>() {
    ...
    // Three Immutator instances
   Immutator<Actually<Map<String, Map<String, String>>>,
     Map<String, Map<String, Map<String, String>>>> immModule = new Immutator<>() {
      public Actually<Map<String, Map<String, String>>> invoke(Map<String,
          Map<String, Map<String, String>>> database) {
        return Actually.ok(database.get(module));
      }
   };
   
   Immutator<Actually<Map<String, String>>,
     Map<String, Map<String, String>>> immStudent = new Immutator<>() {
       public Actually<Map<String, String>> invoke(Map<String, Map<String, String>> modules) {
         return Actually.ok(modules.get(student));
       }
   };

   Immutator<Actually<String>, Map<String, String>> immAssessment = new Immutator<>() {
     public Actually<String> invoke(Map<String, String> students) {
       return Actually.ok(students.get(assessment).toString());
     }
   };

   return dbWrap.init().next(immModule).next(immStudent).next(immAssessment).except(noEntry);
  }
